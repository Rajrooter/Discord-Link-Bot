...
exports (CSV/PDF placeholder), expiry/archiving with background sweeper, context menus at top-level.
"""
...
# ---------------------------------------------------------------------------
# (Extraction and summarization helpers unchanged)
# ---------------------------------------------------------------------------

# shorten_link, excel_preview_table, extract_text_from_bytes, summarize_document_bytes,
# is_media_url, load_rules — unchanged (omitted here for brevity; keep from prior file)
...
# UI Components
# ---------------------------------------------------------------------------
# (CategoryModal, SummaryActionView, SummarizeView, DisclaimerView,
#  LinkActionView, MultiLinkSelectView, ConfirmMultiLinkView,
#  ConfirmDeleteView, ConfirmYesNoView — unchanged from prior; keep them)
...
class LinkManagerCog(commands.Cog, name="LinkManager"):
    ...
    # context menu handlers (handle_summarize_preview_ctx, handle_analyze_link_ctx) stay same

    # (mention handler, on_message logic unchanged except for guild scoping and buttons—keep from prior)
